...
class CAN:                                                                                # Maakt de CAN klasse aan
    ...
    def __init__(self):
        ...
        self.Systeem_Mode = Systeem_Mode
        self.Target_Rempedaal = Target_Rempedaal 
    ...
    def Ontvangen(self):                                                         # Het ontvangen en verwerken van data over de CAN bus
        ...
        if message.arbitration_id == 512:                                      # Leest het bericht uit als deze een ID heeft van 514
             ...
             self.Target_Rempedaal = message514.get('Target_Rempedaal')                  # De data wordt uitgelezen op basis van de verbonden waardes in het .dbc file
             self.Systeem_Mode = message514.get('Systeem_Mode')
             self.Service_Mode = message514.get('Service_Mode')            
             print(self.Target_Rempedaal, self.Systeem_Mode, self.Service_Mode) 
             #print(message514)
