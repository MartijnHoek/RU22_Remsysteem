...
class CAN:                                                                                # Maakt de CAN klasse aan
    ...
    def __init__(self):
        ...
        self.Test_berichten = self.db.get_message_by_name('Test_berichten')                                     # Ontcijfert de Test_berichten uit het .dbc file
    ...
    def Remdruksensoren(self):                                                                 # De data voor de remdruksensoren    
        Test_berichten = self.db.get_message_by_name('Test_berichten')                         # Ontcijfert de Test_berichten uit het .dbc file
        ...
        self.bus.send(Test_berichten_bericht)                                                  # Het bericht wordt over de bus verzonden
    ...
    def Ontvangen(self):                                                         # Het ontvangen en verwerken van data over de CAN bus
        ...
        if message.arbitration_id == 512:                                        # Leest het bericht uit als deze een ID heeft van 512
            message512 = self.db.decode_message(message.arbitration_id, message.data) # Ontcijfert de data afkomstig uit bericht 'message'
